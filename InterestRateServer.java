...
public class InterestRateServer extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    primaryStage.setTitle("InterestRateServer"); // Set the stage title
  ...
  public void connectToClient() {
    try {
      ...
      Platform.runLater(() ->
        ta.appendText("InterestRateServer started at " + new Date() + '\n'));
